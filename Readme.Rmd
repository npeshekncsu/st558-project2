...
Vignettes are explanations of some concept, package, etc. with text, code, and output interweaved. Our goal with this project is to create a vignette about contacting an IQAir APIs using custom functions to query, parse, and return well-structured data. 
