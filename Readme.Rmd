...
### Get air quality and weather metrics based on country, state and city function
...
If `weather_metrics = TRUE` in addition to air quality metrics, weather metrics like, temperature, humidity, wind speed and pressure will be returned. 
...
### Get air quality and weather metrics for country function
...
Let's look at air quality and weather metrics for different countries across the globe. Chosen countries: China, USA, Poland, Australia, Norway.
